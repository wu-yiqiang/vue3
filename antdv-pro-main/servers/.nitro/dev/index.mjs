...
import { provider, isWindows } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, setResponseHeader, send, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, createError, getRouterParam, getQuery as getQuery$1, readBody, getHeader } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/radix3/dist/index.mjs';
import dayjs from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/dayjs/dayjs.min.js';
import { cloneDeep } from 'file:///Users/atlas/vue3/antdv-pro-main/node_modules/lodash-es/lodash.js';
...
const serverAssets = [{"baseName":"server","dir":"/Users/atlas/vue3/antdv-pro-main/servers/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/atlas/vue3/antdv-pro-main","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/atlas/vue3/antdv-pro-main/servers","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/atlas/vue3/antdv-pro-main/servers/.nitro","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/atlas/vue3/antdv-pro-main/servers/.nitro/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/atlas/vue3/antdv-pro-main/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_hVzA63 = () => Promise.resolve().then(function () { return _401$1; });
const _lazy_fmN42d = () => Promise.resolve().then(function () { return _403$1; });
const _lazy_GRMvhd = () => Promise.resolve().then(function () { return _500$1; });
const _lazy_MRT5iw = () => Promise.resolve().then(function () { return index$3; });
const _lazy_0224F8 = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_SfVwZP = () => Promise.resolve().then(function () { return basicList_post$1; });
const _lazy_svjvFo = () => Promise.resolve().then(function () { return consultList_post$1; });
const _lazy_kTlCUt = () => Promise.resolve().then(function () { return create_post$1; });
const _lazy_gigz2W = () => Promise.resolve().then(function () { return crudTable_post$1; });
const _lazy_aH4vDm = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_S114rJ = () => Promise.resolve().then(function () { return index_put$1; });
const _lazy_1dPtBU = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_1cfGsU = () => Promise.resolve().then(function () { return logout$1; });
const _lazy_xBj6PW = () => Promise.resolve().then(function () { return index$1; });
const _lazy_1Kpb8Y = () => Promise.resolve().then(function () { return test_delete$1; });
const _lazy_6cZaJE = () => Promise.resolve().then(function () { return test_post$1; });
const _lazy_dBmtsH = () => Promise.resolve().then(function () { return test_put$1; });
const _lazy_D2Jq1f = () => Promise.resolve().then(function () { return info$1; });

const handlers = [
  { route: '/401', handler: _lazy_hVzA63, lazy: true, middleware: false, method: undefined },
  { route: '/403', handler: _lazy_fmN42d, lazy: true, middleware: false, method: undefined },
  { route: '/500', handler: _lazy_GRMvhd, lazy: true, middleware: false, method: undefined },
  { route: '/', handler: _lazy_MRT5iw, lazy: true, middleware: false, method: undefined },
  { route: '/list/:id', handler: _lazy_0224F8, lazy: true, middleware: false, method: "delete" },
  { route: '/list/basic-list', handler: _lazy_SfVwZP, lazy: true, middleware: false, method: "post" },
  { route: '/list/consult-list', handler: _lazy_svjvFo, lazy: true, middleware: false, method: "post" },
  { route: '/list/create', handler: _lazy_kTlCUt, lazy: true, middleware: false, method: "post" },
  { route: '/list/crud-table', handler: _lazy_gigz2W, lazy: true, middleware: false, method: "post" },
  { route: '/list', handler: _lazy_aH4vDm, lazy: true, middleware: false, method: "post" },
  { route: '/list', handler: _lazy_S114rJ, lazy: true, middleware: false, method: "put" },
  { route: '/login', handler: _lazy_1dPtBU, lazy: true, middleware: false, method: "post" },
  { route: '/logout', handler: _lazy_1cfGsU, lazy: true, middleware: false, method: undefined },
  { route: '/menu', handler: _lazy_xBj6PW, lazy: true, middleware: false, method: undefined },
  { route: '/test', handler: _lazy_1Kpb8Y, lazy: true, middleware: false, method: "delete" },
  { route: '/test', handler: _lazy_6cZaJE, lazy: true, middleware: false, method: "post" },
  { route: '/test', handler: _lazy_dBmtsH, lazy: true, middleware: false, method: "put" },
  { route: '/user/info', handler: _lazy_D2Jq1f, lazy: true, middleware: false, method: undefined }
];
