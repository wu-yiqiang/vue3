export default {
  ...
  'Candidate Starter Groups': '侯选人初选小组',
  ...
  'Startable': '可启动',
  'proces': '过程',
  'This maps to the process definition key.': '将映射到进程定义键。',
  'Element must have an unique id.': '元素必须具有唯一的 ID。',
  'Executable': '可执行文件',
  ...
  'This maps to the task definition key.': '将映射到任务定义键。',
